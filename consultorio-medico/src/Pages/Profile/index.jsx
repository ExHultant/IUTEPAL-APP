...
function ProfilePage() {
  const [perfil, setPerfil] = useState({
    nombre: "Ricardo",
    apellido: "Chavez Mata",
    email: "chavezmataricardo@gmail.com",
    telefono: "+58 414 406 76 11",
    direccion:
      "Av. Don Julio Centeno, Colinas de San Diego, San Diego, Edo. Carabobo, Venezuela.",
  });
  ...
  return (
    <Sidebar pageTitle={"Perfil"}>
      ...
      <h2 className="text-2xl font-bold my-4">Editar Perfil de Usuario</h2>
